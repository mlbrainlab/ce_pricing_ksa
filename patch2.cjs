...
// Wrap Discount Block
let discountBlockStart = `{/* Discount Input */}
                                <div
                                  className={
                                    product.countLabel ? "" : "col-span-2"
                                  }
                                >`;
let discountBlockReplacement = `{/* Discount Input */}
...
code = code.replace(discountBlockStart, discountBlockReplacement);

let discountBlockEnd = `                                  </div>
                                </div>

                                {/* EAI Activation Checkbox */}`;
let discountBlockEndReplacement = `                                  </div>
                                </div>
                                )}

                                {/* EAI Activation Checkbox */}`;

code = code.replace(discountBlockEnd, discountBlockEndReplacement);
